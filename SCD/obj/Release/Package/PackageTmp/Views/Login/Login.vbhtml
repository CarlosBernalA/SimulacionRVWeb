...
<body>
    ...
    <div id="wrapper">
        <div class="vertical-align-wrap">
            <div class="vertical-align-middle">
                <div class="auth-box" style="margin-top:9rem">
                    <div class="login-content-left">
                        <div class="content">
                            <div class="header">

                                <p class="lead"  style="margin-top:5rem">Registro de Usuario</p>
                            </div>
                            <form class="form-auth-small" id="frm-login">
                                <div class="form-group">
                                    <label for="signin-email" class="control-label sr-only">Usuario</label>
                                    <input type="text" class="form-control" id="username" value="" placeholder="DNI">
                                </div>
                                <div class="form-group">
                                    <label for="signin-password" class="control-label sr-only">Password</label>
                                    <input type="password" class="form-control" value="" id="password" value="thisisthepassword" placeholder="Password">
                                </div>
                                ...
                                <button type="button" id="btn_login" class="btn btn-primary btn-lg btn-block">LOGIN</button>
                                <div class="bottom">
                                    <span class="helper-text"><i class="fa fa-lock"></i> <a>Forgot password?</a></span>
                                </div>
                            </form>
                        </div>
                    </div>
                    <div class="right">
                        ...
                        <div class="content text">
                            <h1 class="heading">Brisma</h1>
                            <p>Cuida tu sonrisa</p>
                        </div>
                    </div>
    ...
    <script src="~/Content/assets/vendor/chart-js/Chart.min.js"></script>
    <script src="~/Content/assets/scripts/login.js"></script>
</body>
</html>
