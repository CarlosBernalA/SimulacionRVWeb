...
<!-- Mirrored from demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 Apr 2018 03:07:54 GMT -->
<head>
...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-fixed-top">
            <div class="brand">
                <a href="index.html">
                    <img src="~/Content/assets/img/logo-white.png" alt="Klorofil Pro Logo" class="img-responsive logo">
                </a>
            </div>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="~/Content/assets/img/user.png" alt="Avatar">
                                <span>Samuel</span>
                            </a>
                                        ...
                                        <div class="sidebar-section">
                                            ...
                                            <div class="square-legend">
                                                <ul class="list-unstyled list-inline">
                                                    <li>
                                                        <span class="custom-bg-blue2"></span> 35% Male
                                                    </li>
                                                    <li>
                                                        <span class="custom-bg-blue3"></span> 65% Female
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="widget-metric_11">
                                        ...
                                        <div class="bottom">
                                            <div class="left">
                                                ...
                                                <span class="change">
                                                    <span class="text-indicator-green"><i class="fa fa-caret-up"></i> 18%</span> vs. last week
                                                </span>
                                            </div>
                                            <div class="right">
                                        ...
                                        <div class="col-md-4">
                                            <div id="online-visitors-dashboard" class="online-visitors">
                                                ...
                                                <div class="square-legend">
                                                    <ul class="list-unstyled list-inline">
                                                        <li>
                                                            <span class="referral"></span> Referral
                                                        </li>
                                                        <li>
                                                            <span class="organic"></span> Organic
                                                        </li>
                                                        <li>
                                                            <span class="direct"></span> Direct
                                                        </li>
                                                        <li>
                                                            <span class="email"></span> Email
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-8">
                                            <table class="table table-minimal table-chat-support datatable">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <span class="popover-profile" data-toggle="popover" data-visitor-name="Bruce Evans" data-visitor-img="~/Content/assets/img/people/male1.png"><i class="fa fa-vcard-o"></i></span> Bruce
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <span class="popover-profile" data-toggle="popover"><i class="fa fa-vcard-o"></i></span> Guest
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <span class="popover-profile" data-toggle="popover" data-visitor-name="Joey Felicia" data-visitor-img="~/Content/assets/img/people/female1.png"><i class="fa fa-vcard-o"></i></span> Joey
                                                        </td>
                                                        <td>
                                    ...
                                    <div class="layout-table margin-bottom-30">
                                        <div class="cell">
                                            <div class="chart-metric">
                                                <span class="title">
                                                    <span class="data-legend custom-bg-orange2"></span> Earnings
                                                </span>
                                        ...
                                        <div class="cell">
                                            <div class="chart-metric">
                                                <span class="title">
                                                    <span class="data-legend custom-bg-blue3"></span> Sales
                                                </span>
                                            ...
                                            <div class="row">
                                                <div class="col-xs-6">
                                                    <div class="footer-info">
                                                        ...
                                                        <img src="~/Content/assets/img/people/female2.png" class="picture img-circle" alt="">
                                                        <div class="right">
                        ...
                        <ul class="list-unstyled list-widget-horizontal row">
                            <li class="col-md-3">
                                <div class="widget-metric_3">
                                    ...
                                    <span class="note">
                                        <span class="text-indicator-green">+13.42%</span> since last month
                                    </span>
                                </div>
                            </li>
                            <li class="col-md-3">
                                <div class="widget-metric_4">
                                    ...
                                    <span class="note">
                                        <span class="text-indicator-red">-3.74%</span> since last month
                                    </span>
                                </div>
                            </li>
                            <li class="col-md-3">
			...
			var tour = new Tour(
			{
				steps: [
				{
					...
					onShow: function()
					{
						...
						{
							popupSound.src = "~/Content/assets/audio/popup.ogg";
						}
						else
						{
							popupSound.src = "~/Content/assets/audio/popup.mp3";
						}
...
<!-- Mirrored from demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 Apr 2018 03:09:09 GMT -->
</html>